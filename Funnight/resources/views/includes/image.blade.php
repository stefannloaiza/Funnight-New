<div class="card pub_image">
    ...
    <div class="card-body">
        ...
        <div class="ratings">
            <input id="input-1" name="input-1" class="rating rating-loading btn-stars"  data-id="{{$image->id}}" data-min="0" data-max="5" data-step="1" value="{{ $image->averageRating }}" data-size="xs">
        </div>
